...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Advanture Portal.">
        <meta name="author" content="Raju">


        <!-- App title -->
        <title>Advanture | Admin Panel</title>
                                ...
                                <div class="text-center account-logo-box">
                                    <h2 class="text-uppercase">
                                        <a href="index.html" class="text-success">
                                            <span><img src="https://www.advadventures.com/dist/frontend/img/adv-logo-new.jpg" alt="" height="56"></span>
                                        </a>
                                    </h2>
