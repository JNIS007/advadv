...
if (isset($_POST['submit'])) {
    try {
        ...
        $query = mysqli_query($con,"update cms set 
            `Title` = '$title',
...
<head>
    ...
    <title>Adventure | Edit CSR</title>
            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="page-title-box">
                                <h4 class="page-title">Edit CSR</h4>
                                <ol class="breadcrumb p-0 m-0">
                                    <li><a href="#">Admin</a></li>
                                    <li><a href="#">CSR</a></li>
                                    <li class="active">Edit CSR</li>
                                </ol>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box">
                                <h4 class="m-t-0 header-title"><b>Edit CSR</b></h4>
                                <hr />
                                ...
                                $fetch =mysqli_query($con,"select * from cms where id='$id' and status=1");
