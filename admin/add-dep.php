      ...
      <div class="content-page">
        ...
        <div class="content">
          <div class="container">
            ...
            <form action="depature.php" method="POST" id="postForm">
                 <div class="card-box">
...
<div class="form-group mb-3">
    ...
    <select class="form-control" name="related_post_id" id="postTitle" required>
      ...
      <label for="postTitle">Start Date:</label>
        <input type="date" name="start" class="form-control">
        <label for="postTitle">End Date:</label>
        <input type="date" name="end" class="form-control">
        <label for="postTitle">Cost Per Person:</label>
