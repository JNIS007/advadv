...
if (isset($_POST['submit'])) {
    try {
        ...
        $query = mysqli_query($con, "INSERT INTO cms (Title, Description, Img_url, status) 
                                    VALUES ('$title', '$description', '$img_url', '$status')");
        
        if ($query) {
            $_SESSION['msg'] = "CMS page created successfully";
            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="page-title-box">
                                <h4 class="page-title">Add CSR</h4>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box">
                                <h4 class="m-t-0 header-title"><b>Add CSR</b></h4>
                                <hr />
                                        ...
                                        <form class="form-horizontal" name="category" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <p class="help-block">Upload a featured image for the CMS page (Max 5MB, JPG/PNG/GIF)</p>
                                                </div>
                                            </div>
