...
$query=mysqli_query($con,"update tblposts set PostTitle='$posttitle',CategoryId='$catid',SubCategoryId='$subcatid',PostDetails='$postdetails',PostUrl='$url',Is_Active='$status',lastUpdatedBy='$lastuptdby',Price='$price',Days='$day' where id='$postid'");
if($query)
{
$msg="Post updated ";
}
...
<input type="text" class="form-control" id="day" value="<?php echo htmlentities($row['p']);?>" name="price" placeholder="Enter Price" required>
</div>

<label for="exampleInputEmail1">Day</label>
<input type="text" class="form-control" id="day" value="<?php echo htmlentities($row['d']);?>" name="day" placeholder="Enter Day" required>
</div>
