...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $query = mysqli_query($con, "update tblposts set PostTitle='$posttitle',CategoryId='$catid',PostDetails='$postdetails',PostUrl='$url',Is_Active='$status',lastUpdatedBy='$lastuptdby',Price='$price',Days='$day' where id='$postid'");
        if ($query) {
            $msg = "Post updated ";
        } else {
