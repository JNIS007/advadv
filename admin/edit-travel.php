...
if (isset($_POST['submit'])) {
    try {
        ...
        $query = mysqli_query($con,"update travel_guide set 
            `Title` = '$title',
        ...
        if ($query) {
            $_SESSION['msg'] = "Travel guide updated successfully";
...
<head>
    ...
    <title>Adventure | Edit Travel Guide</title>
            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="page-title-box">
                                <h4 class="page-title">Edit Travel Guide</h4>
                                <ol class="breadcrumb p-0 m-0">
                                    <li><a href="#">Admin</a></li>
                                    <li><a href="#">Travel Guide</a></li>
                                    <li class="active">Edit Travel Guide</li>
                                </ol>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box">
                                <h4 class="m-t-0 header-title"><b>Edit Travel Guide</b></h4>
                                <hr />
                                ...
                                $fetch =mysqli_query($con,"select * from travel_guide where id='$id' and status=1");
                                    ...
                                    <div class="col-md-8">
                                        <form class="form-horizontal" name="category" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" value="<?php echo $data['Title']?>" name="category" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea class="form-control" id="editor" name="description" required><?php echo  $data['Description'] ; ?></textarea>
                                                    <script>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <img src="<?php echo htmlentities($data['Img_url']);?>" width="80" height="60">
